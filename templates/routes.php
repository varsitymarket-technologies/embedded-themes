...
ini_set('error_log', dirname(__FILE__) . '/data/log/error-file.log');
...
elseif (in_array($segment1, [
    'home', 'shop', 'collection', 'cart', 'checkout','login','signup',
    'about', 'contact', 'policy', 'search', 'orders', 'account','faq'
])) {
    $page = $segment1;
}
else {
